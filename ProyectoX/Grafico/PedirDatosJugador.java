...
public class PedirDatosJugador extends JPanel
{
	...
	private void initGUI ()
	{
		...
		{
			ventanaPrincipal.mensajeError("Error", "PedirDatosJugador.initGUI()" + "\n" + e.getMessage(), true);
		}
	}
	...
	private ActionListener listenerEmpezarJuego ()
	{
		return new ActionListener()
        {
            ...
            public void actionPerformed (ActionEvent event)
            {
            	...
            	{
            		ventanaPrincipal.mensajeError("ERROR", "PedirDatosJugador.listenerEmpezarJuego()" + "\n" + e.getMessage(), true);
        		}
	...
	private ActionListener listenerCancelar ()
	{
		return new ActionListener()
        {
            ...
            public void actionPerformed (ActionEvent event)
            {
            	...
            	{
            		ventanaPrincipal.mensajeError("ERROR", "PedirDatosJugador.listenerCancelar()" + "\n" + e.getMessage(), true);
        		}
